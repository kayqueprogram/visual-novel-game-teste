...
style window:
    ...
    background Image("gui/bg-say.png", xalign=0.5, yalign=0.2)
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            #extbutton _("Q.Load") action QuickLoad()
...
screen about():
    ...
    use game_menu(_("Sobre"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Feito com {a=https://www.renpy.org/}Ren'Py{/a}, por: @sirius_sh_xls [renpy.version_only].\n\n")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Pular")
                    textbutton _("Somente texto") action Preference("skip", "toggle")
...
screen history():
    ...
    use game_menu(_("History"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0):
        ...
        if not _history_list:
            label _("O diálogo da história está vazio!")
...
screen keyboard_help():
    ...
    hbox:
        label _("Escape")
        text _("Acessar o menu do game.")

    hbox:
        label _("Ctrl")
        text _("Ignora o diálogo enquanto pressionado.")

    hbox:
        label _("Tab")
        text _("Alterna o salto do diálogo.")
    ...
    hbox:
        label "V"
        text _("Alterna a {a=https://www.renpy.org/l/voicing}autovoz{/a} assistencial.")
...
screen mouse_help():
    ...
    hbox:
        label _("Click(Direita)")
        text _("Acessa o menu do jogo.")

    hbox:
        label _("Rolar mouse para cima\nClique em voltar")
        text _("Reverte para o diálogo anterior.")

    hbox:
        label _("Rolar mouse para baixo")
        text _("Avança para um diálogo posterior.")
...
screen gamepad_help():
    ...
    hbox:
        label _("Y/Botão do topo")
        text _("Ocultar a interface do usuário")
